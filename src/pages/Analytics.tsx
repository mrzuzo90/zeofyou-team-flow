...
import { TrendingUp, Target, Clock, Lightbulb, Users, CheckCircle } from 'lucide-react';
    ...
    <>
      ...
      <div className="flex min-h-screen bg-gray-900">
        ...
        <div className="flex-1">
          ...
          <main className={`px-4 py-6 space-y-8 ${isMobile ? 'max-w-md mx-auto' : 'mx-6'}`}>
            ...
            {/* Balance de Identidades & Estado del Equipo - Responsive Layout */}
            <div className={`${isMobile ? 'space-y-8' : 'grid grid-cols-2 gap-8'}`}>
              ...
              <section>
                ...
                <div className={`grid ${isMobile ? 'grid-cols-2' : 'grid-cols-2 xl:grid-cols-3'} gap-4`}>
