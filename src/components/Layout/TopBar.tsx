      ...
      <div className="flex items-center gap-3 px-4 py-3 lg:px-8">
        ...
        {profile && (
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => nav("/perfil")} className="group flex items-center gap-2.5 rounded-full bg-card/60 p-1 pr-3 transition-colors hover:bg-card lg:hidden">
            ...
            <button onClick={() => nav("/perfil")} className="hidden lg:flex items-center gap-3 rounded-full bg-card/60 px-3 py-1.5 hover:bg-card transition-colors">
